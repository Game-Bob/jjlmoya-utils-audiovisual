...
const UTILITY_ASSET_ROOT = "/_utilities/audiovisual";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/audiovisual/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/audiovisual/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("audiovisual");
