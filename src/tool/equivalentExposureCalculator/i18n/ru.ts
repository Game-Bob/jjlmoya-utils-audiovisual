...
const seo: ToolLocaleContent<EquivalentExposureUI>['seo'] = [
  ...
  {
    type: 'paragraph',
    html: 'Экспозиция в фотографии формируется непрерывным техническим взаимодействием диафрагмы объектива, выдержки затвора и чувствительности ISO сенсора. Любое изменение одного из этих параметров требует точной взаимной компенсации других значений для сохранения итогового светового потока на чувствительной поверхности.',
  },
  {
    type: 'stats',
    items: [
  ...
  {
    type: 'paragraph',
    html: 'Хотя эквивалентные экспозиции обеспечивают одинаковую итоговую яркость на матрице, художественный характер и визуальный вид снимка существенно различаются в зависимости от выбранной комбинации параметров:',
  },
  {
    type: 'list',
    items: [
      "<strong>Диафрагма:</strong> Управляет глубиной резкости и размытием заднего плана. Большие отверстия создают мягкое эстетичное боке.",
      "<strong>Выдержка:</strong> Управляет передачей движения, позволяя заморозить динамику или передать художественный смаз.",
      "<strong>ISO:</strong> Усиливает электрический сигнал матрицы при слабом свете ценой увеличения цифрового шума."
    ],
