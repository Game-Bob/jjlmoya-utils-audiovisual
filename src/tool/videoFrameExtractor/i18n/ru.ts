...
const seo: VideoFrameExtractorLocaleContent['seo'] = [
    ...
    { type: 'paragraph', html: 'Каждое видео содержит сотни кадров. Найдите среди них лучшие моменты без потери качества и нарушения приватности. Наш инструмент обеспечивает мгновенную и точную обработку любых видеофайлов непосредственно в вашем браузере без отправки данных в сеть.' }
];
